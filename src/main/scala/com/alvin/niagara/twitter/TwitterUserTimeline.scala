...
object TwitterUserTimeline extends App with Config {
  ...
  restClient.userTimelineForUser(screen_name = user, since_id = since_id, count = 1000)
    .map { ratedData =>
